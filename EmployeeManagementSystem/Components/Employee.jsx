    ...
    axios
      ...
      .then((employeeResult) => {
        if (employeeResult.data.Status) {
          ...
          // Fetch category data after fetching employee data
          return axios.get("http://localhost:3000/auth/category");
        } else {
            ...
            {employee.map((e) => (
              <tr>
                ...
                <td>
                  ...
                  {categories.find((category) => category.ID === e.category_id)?.name || 'N/A'}
                </td>
